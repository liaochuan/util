...
import com.xy.ad.common.converter.ObjectConvertorMapper;
import com.xy.ad.common.converter.BaseMapStruct;
...
public interface ${tableInfo.className}Convertor extends BaseMapStruct<${tableInfo.className}DTO, ${tableInfo.className}VO, ${tableInfo.className}Entity> {
